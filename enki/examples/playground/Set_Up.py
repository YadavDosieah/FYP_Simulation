...
plt.annotate(s='Goal Area', xy=(150,290), xytext=(200,315), arrowprops=dict(arrowstyle='<-',color='b'),color='b')
plt.annotate(s='Initial Area for Sheep and Shepherds', xy=(10,190), xytext=(10,345), arrowprops=dict(arrowstyle='<-',color='g'),color='g')
...
for n in range(noOfShepherd):
    shepherdDot[n] = plt.Circle((random.randint(0,300),random.randint(0,300)),3.7,fc='r')
    ax.add_patch(shepherdDot[n])

legendbox = plt.Rectangle((240,340),60,60,fill=False,edgecolor='k')
